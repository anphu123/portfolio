        ...
        <nav className="flex items-center justify-between mb-12 animate-fade-in-down print:hidden">
          <div className="flex items-center gap-4">
             ...
             <div className="flex flex-col">
               <span className="text-[10px] uppercase tracking-[0.2em] text-slate-500 font-semibold">Portfolio</span>
               <span className="font-bold text-slate-900 dark:text-slate-200 text-sm transition-colors">Huỳnh Mai An Phú</span>
             </div>
          </div>
