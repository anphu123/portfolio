...
export const Footer: React.FC = () => {
  ...
  return (
    <footer
      className="pt-14 pb-10 mt-14 print:hidden"
    ...
    >
      ...
      {/* Bottom doodle signature */}
      <div className="flex justify-center mt-8">
        <svg width="120" height="30" viewBox="0 0 120 30" fill="none" style={{ opacity: 0.25 }}>
          <path d="M10,20 Q20,5 30,15 Q40,25 50,10 Q60,5 70,15 Q80,25 90,10 Q100,5 110,20" stroke="#2d2013" strokeWidth="2" fill="none" strokeLinecap="round"/>
          <circle cx="60" cy="26" r="2" fill="#e85d26"/>
        </svg>
      </div>
    </footer>
  );
